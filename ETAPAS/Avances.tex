...
\begin{itemize}
	...
	\item Unidades de procesamiento de señal (Filtros dentro del transductor, FPGA o DSP, o procesadores de propósitos generales).
\end{itemize}
...
\begin{itemize}
	\item Una sección analógica de RF (antena, filtros RF, multiplexores, LNA, atenuadores, mezcladores)
		...
		\subitem Los demas items (multiplexores, LNA, atenuadores y mezcladores) están integrados en el tranceptor AD9363.
		
	\item Una sección analógica de Banda base (filtros analógicos, ADS y/o DAC).
		\subitem toda esta sección está implementada dentro del tranceptor nombrado anteriormente.
		 
	\item Unidades de procesamiento de señal (Filtros dentro del transductor, FPGA o DSP, o procesadores de propósitos generales). Esta sección se divide entre lo siguiente:
		...
		\subitem La información I/Q pasa por el USB al host y de ahí se puede continuar procesandola con MATLAB.
\end{itemize}
