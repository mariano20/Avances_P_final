...
Del link anterior extraemos los datos para utilizaarlos en la calculadora que el programa de diseño (KiCad) nos proporciona.
...
Pero el fabricante JLCPCB tiene su propia calculadora, esta herramienta arroja los siguientes resutados: 

\begin{figure}[H]
	\centering
	\subfigure[50 ohm Terminación unica ]{\includegraphics[scale=0.4]{Imagenes/PCB/jlc_unica} \label{jlc1}}
	\subfigure[Señal 50 ohm Diferencial]{\includegraphics[scale=0.4]{Imagenes/PCB/jlc_dif}\label{jlc2}}
	\caption{Ancho de pista según calculadora de JLCPCB}
\end{figure}


Entonces según el fabricante, el ancho debe ser:

\textbf{Terminación unica:} 0.29337 [mm]

Como se ve en la captura, si la traza es diferencial, la impedancia recomendad va desde los 70 a los 114 ohm. 
