...
\begin{figure}[H]
	\centering
	\subfigure[Un solo pin de interrupción]{\includegraphics[scale=0.6]{Imagenes/stm/1interrupt} \label{I1}}
	\subfigure[2 Pines de interrupción]{\includegraphics[scale=0.6]{Imagenes/stm/2interrupt}\label{I2}}
...
\begin{itemize}
	...
	\item Bulk transfers son las más rápidas\footnote{Si el bus no tiene ningún otro dispositvo conectado.} pero no garantiza sincronización.
	\item Interrupt transfers poseen latencia máxima garantizada.
	\item Isochronus transfers tienen sincronización asegurada pero no hay correción de errores.
