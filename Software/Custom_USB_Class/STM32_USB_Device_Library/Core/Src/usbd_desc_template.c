...
#define USBD_PID                      0x0022  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            0x0409  /* Replace '0xbbb' with your device language ID (0x0409 = English (US)*/
#define USBD_MANUFACTURER_STRING      "STMicroelectronics" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "Stm32CustomUSBDeviceClass" /* Add your product High Speed string */
/*#define USBD_PRODUCT_FS_STRING        "xxxxx" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "Stm32CustomUSBDeviceClass Config" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "Stm32CustomUSBDeviceClass Interface" /* Add your Interface High Speed string */
